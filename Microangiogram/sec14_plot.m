...
%         subplot(3,2,[1 2]);  cla;
        subplot(5,1,1);  cla;
            ...
            line([1 nz],[1 1]*log10(Dz(pp.zz(2))));  line([1 1]*pp.zz(2),get(gca,'ylim'));  line([1 1]*pp.zz(1),get(gca,'ylim'));  title(mat2str(pp.zz));
%         subplot(3,2,[3 5]);  cla;  hold on;
        subplot(5,1,(2:5));  cla;  hold on;
            PlotImage(log10(squeeze(max(DD(pp.zz(1):pp.zz(2),:,:),[],1)))',false,[.1 .95],true);  title('MIP');
